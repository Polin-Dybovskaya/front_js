...
export default {
  ...
  methods: {
    showAlert() {
      alert('Тест 2\n Вам будет дано 60 секунд. \n За это время ваша задача найти все слова, где значение слова соответсвует цвету слова "оттенка"');
      this.startTimer();
    },
      ...
      this.timerInterval = setInterval(() => {
        this.remainingTime--;
        console.log('2 ',this.remainingTime)
    ...
    nextQuiz() {
      this.selectedWords = [];
        ...
        console.log(n,this.rightcolor,this.rusrightcolor)
